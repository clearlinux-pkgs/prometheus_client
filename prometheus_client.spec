...
Source0  : https://files.pythonhosted.org/packages/61/84/9aa657b215b04f21a72ca8e50ff159eef9795096683e4581a357baf4dde6/prometheus_client-0.4.2.tar.gz
...
%prep
%setup -q -n prometheus_client-0.4.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1539662700

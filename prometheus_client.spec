...
Source0  : https://files.pythonhosted.org/packages/76/79/98ca521254ee7001bafce0844bd58d3c40d339918f813248c46e678aba58/prometheus_client-0.10.0.tar.gz
...
%prep
%setup -q -n prometheus_client-0.10.0
cd %{_builddir}/prometheus_client-0.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617403977
